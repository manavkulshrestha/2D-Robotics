...
// sturcture to hold parameters to be passed to actions
//     all actions must accept this struct as an argument
//     add new params as needed. Fuctions will only access
//     the params they need, which we will know while 
//     building
typedef struct _actionparams {               /* DO NOT ALTER */
  double target[3];
  double target_offset;
} ActionParams;

// the action_params constructor (base case to be passed to all actions)
//     add default values here as new params are added
//     above
#define DEFAULT_ACTIONPARAMS ((ActionParams){.target = {0.0, 0.0, 0.0}, .target_offset = 0.0})
...
#define R_JOINT        0.04  /* [m] - the radius of an arm joint */
...
#define STATIC_FORCE_THRESHOLD 10.0 // 10.0
